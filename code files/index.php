                ...
                <div class="row h-100 align-items-center">
                    <div class="col-lg-12">
                        <div class="text-white">
                            ...
                            Guide you Home</h1><h4>"Selling your home is not just about moving; it's about new beginnings”,<br>   
                                     "Buying a home is not just a transaction; it's a life-changing experience.”</h4>
                    ...
                    <div class="row">
                        <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
                                ...
                                <p>Alpha Homes provides a seamless and efficient platform for homeowners, investors, and real estate agents to sell properties with ease. Our website offers comprehensive listing services, allowing users to create detailed property profiles with high-quality images, virtual tours, and accurate descriptions to attract potential buyers.</p>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
                                ...
                                <p>Alpha Homes offers a seamless rental service designed to help landlords, property managers, and tenants connect effortlessly. Our platform allows property owners to list rental properties with detailed descriptions, high-quality images, and virtual tours, making it easier for potential tenants to find their ideal home.</p>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
                                ...
                                <p>Alpha Homes provides a powerful and user-friendly platform for homeowners, real estate agents, and investors to sell properties quickly and efficiently. Our property selling service allows users to create detailed listings with high-quality images, virtual tours, and comprehensive descriptions, ensuring maximum visibility to potential buyers</p>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
                                ...
                                <p>Alpha Homes offers comprehensive legal investment services to help real estate investors make informed and secure property decisions. Our platform provides expert guidance on legal frameworks, contracts, and regulatory compliance, ensuring that every investment is protected and aligned with local property laws.</p>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <ul>
                                <li class="mb-4 text-white d-flex"> 
									...
									<div class="pl-2">
										...
										<p>Alpha Homes is a top-rated real estate platform trusted by homeowners, buyers, landlords, and investors for its efficiency, reliability, and innovation. Our commitment to excellence has made us a preferred choice in the real estate industry, offering seamless property transactions, cutting-edge technology, and unparalleled customer support.</p>
									</div>
                                </li>
                                <li class="mb-4 text-white d-flex"> 
									...
									<div class="pl-2">
										...
										<p>At Alpha Homes, we redefine the real estate experience by combining innovation, security, and premium service to deliver unmatched quality in every transaction. Whether you’re buying, selling, renting, or investing, our cutting-edge platform ensures seamless, efficient, and transparent property dealings.</p>
									</div>
                                </li>
                                <li class="mb-4 text-white d-flex"> 
									...
									<div class="pl-2">
										...
										<p>At Alpha Homes, we take pride in connecting you with a team of highly experienced and professional real estate agents who are dedicated to delivering exceptional service. Our agents bring in-depth market knowledge, negotiation expertise, and personalized guidance, ensuring that every buying, selling, or rental transaction is smooth and successful.</p>
									</div>
                                </li>
                            </ul>
                        </div>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="icon-thumb-one text-center mb-5">
                            ...
                            <p>Once a connection is made, our platform allows for direct communication between buyers, sellers, landlords, and tenants. Through live chat, messaging, and agent support, you can discuss property details, schedule viewings, and negotiate terms conveniently.</p>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="icon-thumb-one text-center mb-5">
                            ...
                            <p>Our experts carefully review property-related documents, including title deeds, sale agreements, rental contracts, mortgage papers, and ownership history to confirm authenticity and avoid legal disputes.</p>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="icon-thumb-one text-center mb-5">
                            ...
                            <p>At Alpha Homes, we make property acquisition simple, secure, and efficient, whether you're a first-time homebuyer, seasoned investor, or business looking for real estate opportunities. Our platform provides end-to-end support, ensuring you acquire properties that match your needs and financial goals.</p>
                        </div>
                    </div>
                </div>
            </div>
