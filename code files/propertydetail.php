            ...
            <div class="container">
                <div class="row">
                                        ...
                                        <div class="agent-data text-ordinary mt-sm-20">
                                            ...
                                            <div class="mt-3 text-secondary hover-text-success">
                                                <ul>
                                                    ...
                                                    <li class="float-left mr-3"><a href="https://www.instagram.com/?hl=en"><i class="fab fa-instagram"></i></a></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="col-lg-4">
                                    ...
                                    <!-- Buy Now Button Below the Images -->
                                   <!-- Inside the right sidebar (col-lg-4) -->
